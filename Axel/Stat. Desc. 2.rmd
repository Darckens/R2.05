...
Le test de Shapiro-Wilk appliqué à la variable **`X`** donne une statistique **W = 0.95558** avec une **p-valeur de 0.05809**.  
...
Le test de Shapiro-Wilk appliqué à la variable **`Y`** donne une statistique **W = 0.92148** avec une **p-valeur de 0.002668**.  
